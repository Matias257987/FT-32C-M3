...
function problemC () {
  ...
  promisifiedReadFile('poem-one/stanza-02.txt').then(stanza2 => {
    blue(stanza2);
    return promisifiedReadFile('poem-one/stanza-03.txt').then(stanza3 => blue(stanza3));
    console.log('done');
  });
...
function problemE () {
  ...
  promisifiedReadFile('poem-one/stanza-03.txt').then((stanza3) => {
    blue(stanza3);
    return promisifiedReadFile('poem-one/stanza-04.txt').then((stanza4) => blue(stanza4));
  })
  .catch((err) => magenta(new Error(err)));
}
